...
public class SpringExternalReferenceResolverTest extends XWorkTestCase {
    ...
    public void setUp() throws Exception {
        ...
        applicationContext = new ClassPathXmlApplicationContext(
                "com/opensymphony/xwork2/spring/resolverApplicationContext.xml");
        //ensure we're using the default xwork configuration
        XmlConfigurationProvider c = new XmlConfigurationProvider("com/opensymphony/xwork2/spring/xwork-ext.xml");
