...
/**
 * Unit test for MVELValueStack.
 */
public class MVELValueStackTest extends XWorkTestCase {
    ...
    private ValueStack createValueStack() {
        return createValueStack(true);
    }

    private ValueStack createValueStack(boolean allowStaticMethodAccess) {
        CompoundRootAccessor compoundRootAccessor =  new CompoundRootAccessor();
        container.inject(compoundRootAccessor);
        MVELValueStackFactory factory = new MVELValueStackFactory();
        factory.setAllowStaticMethodAccess(String.valueOf(allowStaticMethodAccess));
    ...
    public void testExpOverridesCanStackExpUp() throws Exception {
        ...
        ValueStack vs = createValueStack();
    ...
    public void testStaticMethodDisallow() {
        ValueStack vs = createValueStack(false);
...
*/
    ...
    public void testNullMethod() {
        ...
        assertNull(stack.findValue("@com.opensymphony.xwork2.util.ValueStackTest@staticNullMethod()"));
    }
    ...
    public void testPrimitiveSettingWithInvalidValueAddsFieldErrorInDevMode() {
        ...
        ((MVELValueStack)stack).setDevMode("true");
        stack.push(action);
    ...
    public void testPrimitiveSettingWithInvalidValueAddsFieldErrorInNonDevMode() {
        ...
        ValueStack stack = createValueStack();
        stack.getContext().put(XWorkConverter.REPORT_CONVERSION_ERRORS, Boolean.TRUE);
        ((MVELValueStack)stack).setDevMode("false");
        stack.push(action);
        stack.setValue("bar", "3x");
    ...
    public void testSerializable() throws IOException, ClassNotFoundException {
        ...
        ValueStack newVs = (ValueStack) ois.readObject();
    ...
    public void testSetNullList() {
        ...
        vs.getContext().put(ValueStack.REPORT_ERRORS_ON_NO_PROP, Boolean.TRUE);
        vs.push(foo);
    ...
    public void testConstructorWithAStack() {
        ...
        ValueStack stack2 = new MVELValueStack(stack,
